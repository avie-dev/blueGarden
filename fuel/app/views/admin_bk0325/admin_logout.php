	    ...
	    <!-- login -->
	   	<div id="bluegarden_content">
				<div id="bluegarden_center">
					<table width="90%" style="border:none" class="loginspacer">
							<tr style="border:none">
								<td style="border:none">ログアウトしました</td>
							</tr>
					</table>
				</div>
				<div id="bluegarden_center">
				<p class="columntitle" style="text-align:center;">Admin ログイン</p>
					  ...
					  <form id="form1" method="post" action="top">
						...
						<table width="90%" style="border:none" class="loginspacer">
							...
							<tr>
								...
								<td style="border:none"><input type="text" name="password" id="password" class="input_box"/></td>
							</tr style="border:none">
							<tr>
