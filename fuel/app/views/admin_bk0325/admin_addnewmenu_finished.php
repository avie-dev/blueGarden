					...
					<table width="100%">
						...
						<tr>
							<td colspan="2" style="font-size: 18px;"　>
								<strong>サービス・メニュー新規登録　―完了―</strong><hr />
							</td>
							
						</tr>	
						
						<tr><td>サービス・メニュー新規登録完了しました。</td></tr>
						
					</table> 
						
							<tr>	
								<td align="center" colspan="2">
								<form action="top" name="addnewmenu_ok_top" method="post"　>
									<input name="submit" type="submit" value="Myページトップへ" >
									
								</form>
									<form action="menuinfo" name="addnewmenu_ok" method="post"　>
									<input name="submit" type="submit" value="メニュー管理ページトップへ" >
