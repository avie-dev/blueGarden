					...
					<table width="100%">
						...
						<tr>
							<td colspan="2" style="font-size: 18px;"　>
								<strong>従業員新規登録　―完了―</strong><hr />
							</td>
							
						</tr>	
						
						<tr><td>従業員の新規登録が完了しました。</td></tr>
							...
							<tr>	
								...
								<form action="cusinfo" name="addnewmem_ok" method="post"　>
									<input name="submit" type="submit" value="お客様管理ページトップへ" >
