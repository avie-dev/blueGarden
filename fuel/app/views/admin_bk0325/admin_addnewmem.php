						...
						<div class="box-type1 ns">
						  <table width="100%" border="0" class="type1">
							<tr>
							  ...
							  <td>
								<input type="text" id="bt_form_cus_mail" name="cus_mail"  size="70" maxlength="128" value="" style="ime-mode:disabled">
										<p class="caption"></p>
								<p class="attention"></p>
							  </td>
							</tr>
							<tr>
							  ...
							  <td>
								<input type="text" id="bt_form_cus_name" name="cus_name"  size="50" maxlength="20" value="" style="ime-mode:active">
							...
							<tr>
							  ...
							  <td>
								<input type="text" id="bt_form_cus_kana" name="cus_kana"  size="50" maxlength="20" value="" style="ime-mode:active">
							...
							<tr>
							  ...
							  <td>
								<input type="text" id="bt_form_cus_tel" name="cus_tel"  size="38" maxlength="15" value="" style="ime-mode:disabled">
							...
							<tr>
							  ...
							  <td>
								<input type="text" id="bt_form_cus_zip" name="cus_zip"  size="18" maxlength="7" value="" style="ime-mode:disabled">
										<input type="button" value="住所検索" onclick="CallZip(this.form, this.form.bt_form_cus_zip, null, this.form.bt_form_cus_pref, this.form.bt_form_cus_addr1);return false">
							...
							<tr>
							  <th width="150">性別</th>
							  <td>
								<input id="bt_form_cus_sex1" type="radio" value="1" name="cus_sex" ><label for="bt_form_cus_sex1">男性</label>
								<input id="bt_form_cus_sex2" type="radio" value="2" name="cus_sex" ><label for="bt_form_cus_sex2">女性</label><br>
							...
							<tr>
							  <th><span class="attention">＊</span>パスワード</th>
								<td>
								 <input type="password" id="bt_form_loginpw" name="loginpw"  size="50" maxlength="20" value="" style="ime-mode:disabled">
								  <p class="caption">※半角英数字 4～20文字で入力してください</p>
								 
								  <input type="password" id="bt_form_loginpw_chk" name="loginpw_chk"  size="50" maxlength="20" value="" style="ime-mode:disabled">
							...
							<tr>	
								...
								<form action="addnewmem_confirm" name="addnewmem_confirm" method="post"　>
