				...
				<div class="coldivider_center" style="margin-top:80px;">
					...
					<p>&nbsp;</p>
						<table width="100%" border="0" class="type1">
							<tr>
							  <th width="150">指名</th>
							   <td style="border: 1px solid #99bbff;">&nbsp;</td>
							</tr>
							<tr>
							  <th width="150"></span>メニュー</th>
							 <td style="border: 1px solid #99bbff;">&nbsp;</td>
							</tr>
							<tr>
							  <th width="150"></span>オプション</th>
							  <td style="border: 1px solid #99bbff;">&nbsp;</td>
							</tr>
							<tr>
							  <th width="150">日付</th>
							...
							<tr>
							  <th width="150">合計金額</th>
							   <td style="border: 1px solid #99bbff;">&nbsp;</td>
							</tr>
						</table>
						
					</div>
					<div class="hdivider"><strong><span style="font-size:20px; margin-bottom:20px padding-bottom:15px;">お客様情報</span></strong>
					<p>&nbsp;</p>
						  <table width="100%" border="0" class="type1">
							<tr>
							...
							<tr>
							 ...
							 <td style="border: 1px solid #99bbff;">&nbsp;</td>
								...
								<form action="editreserve" name="reserve_edit" method="post"　>
									<input name="submit" type="submit" value="編集する" >	
								</form>
								<form action="deletereserve" name="reserve_delete" method="post"　>
