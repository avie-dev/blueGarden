						...
						<div id="fragment-2">
							<form name="search_menuinfo" method="post" action="search_menu">
								...
								<select id="bt_form_menuinfo" name="bt_form_menuinfo">
									...
									<option value="内容(コース)">内容(コース)</option>
									<option value="内容(フェイシャル)">内容(フェイシャル)</option>
									<option value="内容(オプション)">内容(オプション)</option>
								...
								<div class="box-type1 ns">
								  <table width="100%" border="0" class="type1">
									...
									<tr>
									  <th width="150">内容</th>
									  <td>
										<input type="text" id="bt_form_service_content" name="service_content"  size="50" maxlength="40" style="ime-mode:active">
