									...
									<table id="schedTable">
										...
										<thead>
											<tr>
												...
												<th><span id="schedHdr6">誕生日</span></th>
												<th><span id="schedHdr7">登録日付</span></th>
										...
										<tbody>
											...
											<tr>
												...
												<td class="txt"><?php echo $row['sex']; ?></td>
												<td class="txt"><?php echo $row['age']; ?></td>
												<td class="txt"><?php echo $row['birthy'];?><?php echo '年';?>
												<?php echo $row['birthm'];?><?php echo '月';?>
												<?php echo $row['birthd'];?><?php echo '日';?>
												</td> <?php }?>
												<td class="txt"><?php echo $row['created_at']; ?> </td>
