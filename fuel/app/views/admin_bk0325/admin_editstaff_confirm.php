						...
						<div class="box-type1 ns">
						  <table width="100%" border="0" class="type1">
							...
							<tr>
							 ...
							 <td style="border: 1px solid #99bbff;"><?php echo $staff_no; ?>&nbsp;</td>
							</tr>
							<tr>
							  <th width="150"><span class="attention">＊</span>スタッフ名</th>
							 <td style="border: 1px solid #99bbff;"><?php echo $staff_name; ?>&nbsp;</td>
							</tr>
							<tr>
							...
							<tr>
							  <th width="150">時給</th>
							   <td style="border: 1px solid #99bbff;"><?php echo $rate; ?>&nbsp;</td>
							</tr>
							<tr>	
								<td align="center" colspan="2">
								<form action="editstaff_finished" name="editstaff_finished" method="post"　>
									<input name="submit" type="submit" value="確定する" >
									<!--<input type="hidden" name="cus_birthy" value="<?php //print($_POST['$cus_birthy']) ?>"/> -->
