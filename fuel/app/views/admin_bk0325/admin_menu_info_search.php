									...
									<table id="schedTable">
										...
										<thead>
											<tr>
												...
												<th><span id="schedHdr4">基本金額</span></th>
										...
										<?php foreach((array)$rows as $row): ?>
											<tr>
												...
												<td class="txt"><?php echo $row['svc_no']; ?></td>
												<td class="txt"><a href="menudetails"><?php echo $row['svc_name']; ?></a></td>
												<td class="txt"><?php echo $row['svc_contents']; ?></td>
												<td class="txt"><?php echo "￥".$row['svc_price_regular']; ?></td>		
												<?php }
												if($category==='option'){
												?>
												<td class="txt"><?php echo $row['opt_no']; ?></td>
												<td class="txt"><a href="menudetails"><?php echo $row['opt_name']; ?></a></td>
												<td class="txt"><?php echo $row['opt_contents']; ?></td>
												<td class="txt"><?php echo "￥".$row['opt_price_regular']; ?></td>
												<?php }?>
											</tr>
										<?php endforeach; ?> 
										</tbody>
