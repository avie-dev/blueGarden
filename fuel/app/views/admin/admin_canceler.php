	    ...
	    <!-- login -->
	   	<div id="bluegarden_content">
				...
				<div class="coldivider_center" style="margin-top:80px;">
					<form action="canceler_finished" id="canceler_finished" name="canceler_boot" method="post"　>
					 
						<table width="100%" style="border:none">
							<tr>
								<td colspan="2" style="font-size: 18px;"　>
									<strong>過去の予約一括キャンセル</strong><hr />
								</td>
					...
					<table width="100%">
						...
						<tr><td>
									<input action="action" type="button" value="修正する" onclick="history.go(-1);" /></td></tr>
