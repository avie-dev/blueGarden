					...
					<table width="100%">
						...
						<tr>
							<td colspan="2" style="font-size: 18px;"　>
								<strong>自動配信メール設定　―完了―</strong><hr />
							</td>
							
						</tr>	
						
						<tr><td>自動配信メール設定を完了しました。</td></tr>
						
					</table> 
						
							<tr>	
								<td align="center" colspan="2">
								<form action="top" name="gotop" method="post"　>
									<input name="submit" type="submit" value="Myページトップへ" >
									
								</form>
									<form action="mail" name="mail_top" method="post"　>
									<input name="submit" type="submit" value="メール設定トップへ" >
