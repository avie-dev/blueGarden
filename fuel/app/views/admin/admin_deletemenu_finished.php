					...
					<table width="80%">
					 ...
					 <form id="quit" method="post" action="">
						...
						<table>
							...
							<tr>
								<td align="center">
									<form action="top" name="addnewmem_ok" method="post"　>
								...
								<td align="center" >
									...
									<form action="menuinfo" name="addnewmem_ok" method="post"　>
									<input name="submit" type="submit" value="メニューのトップへ" >
