					...
					<table width="100%">
								...
								<tr>
									<td colspan="2" style="font-size: 18px;"　>
										<strong>サービス・メニュー編集確認</strong><hr />
									</td>
						...
						<div class="box-type1 ns">
								  <table width="100%" border="0" class="type1">
									<tr>
									  ...
									  <td>
										<?php echo $svc_name; Session::set('servicename',$svc_name);?>
									...
									<tr>
									  <th width="150">内容</th>
									  <td>
										<?php echo $svc_content; Session::set('servicecontent',$svc_content);?>
									  </td>
									</tr>
									<tr>
									  <th width="150">基本価格(税込)</th>
									  <td>
										<?php echo $svc_price; Session::set('serviceprice',$svc_price);?>円
									  </td>
									</tr>
									<tr>
									  <th width="150">会員価格(税込)</th>
									  <td>
										<?php echo $svc_price_mem;Session::set('servicepricemem',$svc_price_mem); ?>円
									  </td>
									</tr>
									<tr>
									  <th width="150">継続価格(税込)</th>
									  <td>
										<?php echo $svc_price_cont;Session::set('servicepricecont',$svc_price_cont); ?>円
									  </td>
									</tr>
															
									<tr>	
										<td align="center" colspan="2">
										<form action="editmenu_finished" name="editmenu_finished" method="post"　>
