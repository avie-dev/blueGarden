	    ...
	    <!-- login -->
	   	<div id="bluegarden_content">
				...
				<div class="coldivider_center">
						<form name="mailheadfoot" method="post" action="mailheadfoot_confirm">
								
								<table>
								<tr><td>&nbsp;</td></tr>
								<tr><th width="150"><span class="attention">＊</span>種類</th>
									<td>	<?php echo $type ?>	</td>
								...
								<tr>
									  <th width="150"><span class="attention">＊</span>タイトル</th>
									  <td>
									  <?php echo Form:: input('mhf_title',Input::post('mhf_title',$row['title'])) ?>
											<p class="caption"></p>
										<p class="attention"></p>
									  </td>
								</tr>
								...
								<tr>
									  <th width="150">文書ヘッダ</th>
										...
										<td class="ptablespacer">
										 <?php echo Form:: textarea('header',Input::post('header',$row['header']),array('cols'=>'70','rows'=>'7') )?>
								...
								<th width="150">メール内容</th>
										...
										<td class="ptablespacer">
										 ...
										 <?php echo Form:: textarea('body',Input::post('body',$row['body']),array('cols'=>'70','rows'=>'12') ) ?>
										</td>
								</tr>
								<tr>
									  <th width="150">文書フッタ</th>
										...
										<td class="ptablespacer">
										 <?php echo Form:: textarea('footer',Input::post('footer',$row['footer']),array('cols'=>'70','rows'=>'7') ) ?>
										</td>
								</tr>
								<tr><td>
								
								<input type="submit" name="mailheadfoot_reg" value="登録する">
								<input action="action" type="button" value="戻る" onclick="history.go(-1);" /></td></tr>
								<?php endforeach ?>
							</table>
							</form>
							<p>&nbsp;</p>
