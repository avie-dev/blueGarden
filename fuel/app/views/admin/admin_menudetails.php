	    ...
	    <!-- login -->
	   	<div id="bluegarden_content">
				...
				<div class="coldivider_center" style="margin-top:80px;">
					...
					<!--div class="hdivider"><strong><span  style="font-size:20px; margin-bottom:20px">予約内容</span></strong>
					<p>&nbsp;</p-->
					
					<?php Session::set('category',$category);
						  Session::set('svc_name',$svc_name);
					?>
					<?php foreach($menu as $mu): ?>
						
						<div class="box-type1 ns">
						<table width="100%" border="0" class="type1">
						<?php  if(($category==='course')||($category==='facial')){ ?>
									<tr>
									  <th width="150">サービス名</th>
									  <td style="border: 1px solid #99bbff;"><?php echo $mu['svc_name'];Session::set('service_name',$mu['svc_name']);?></td>
									</tr>
									
									<tr>
									  <th width="150">内容</th>
									  <td style="border: 1px solid #99bbff;"><?php echo $mu['svc_contents']; ?></td>
									</tr>
									
									<tr>
									  <th width="150">基本価格(税込)</th>
									  <td style="border: 1px solid #99bbff;"><?php echo $mu['svc_price_regular']."円"; ?></td>
									</tr>
									<tr>
									  <th width="150">会員価格(税込)</th>
									  <td style="border: 1px solid #99bbff;"><?php echo $mu['svc_price_member']."円"; ?></td>
									</tr>
									<tr>
									  <th width="150">継続価格(税込)</th>
									  <td style="border: 1px solid #99bbff;"><?php echo $mu['svc_price_cont']."円"; ?></td>
									</tr>
									<tr>&nbsp;</tr>
									<!--td></td-->
									
									<?php }else if(($category==='option')){ ?>
									<tr>
									  <th width="150">サービス名</th>
									  <td style="border: 1px solid #99bbff;"><?php echo $mu['opt_name'];Session::set('service_name',$mu['opt_name']);?></td>
									</tr>
									
									<tr>
									  <th width="150">内容</th>
									  <td style="border: 1px solid #99bbff;"><?php echo $mu['opt_contents']; ?></td>
									</tr>
									
									<tr>
									  <th width="150">基本価格(税込)</th>
									  <td style="border: 1px solid #99bbff;"><?php echo $mu['opt_price_regular']."円"; ?><br></td>
									</tr>
									<tr>
									  <th width="150">会員価格(税込)</th>
									  <td style="border: 1px solid #99bbff;"><?php echo $mu['opt_price_member']."円"; ?><br></td>
									</tr>
									<tr>
									  <th width="150">継続価格(税込)</th>
									  <td style="border: 1px solid #99bbff;"><?php echo $mu['opt_price_cont']."円"; ?><br></td>
									</tr>
									<tr><td>&nbsp;</td></tr>
									<?php } ?>
					<?php endforeach; ?> 										
								  ...
								  <br>
								<center>
								<form action="editmenu" name="menu_edit" method="post"　>
									<input name="submit" type="submit" value="編集する" >	
								</form>
								<form action="deletemenu" name="menu_delete" method="post"　>
