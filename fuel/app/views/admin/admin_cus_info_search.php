									...
									<table id="schedTable">
										...
										<thead>
											<tr>
												...
												<th><span id="schedHdr2">メールアドレス</span></th>
												<th><span id="schedHdr3">生年月日</span></th>
												<th><span id="schedHdr4">性別</span></th>
												<th><span id="schedHdr5">住所</span></th>
												<th><span id="schedHdr6">電話番号</span></th>
												<th><span id="schedHdr7">登録日</span></th>
											</tr>
										</thead>
										<tbody>
											<?php $field = Session::get('field');
												$profile =\Session::get('authrec_id');?>
											...
											<tr>
												...
												<form name="memprofile" method="post" action="memprofile">	
													<td><input type="submit" name="id" value="<?php echo $data['id'];?>" class="box"></td>
												
												</form>	
												
												<td class="txt"><?php echo Arr::get($profile, "name", "");?> </td>
												<td class="txt"><?php echo Arr::get($profile, "kana", "");?> </td>
												<td class="txt"><?php echo $data['email'];  ?> </td>
												<td class="txt"><?php echo Arr::get($profile, "birthy", "");?> 年
																<?php echo Arr::get($profile, "birthm", "");?> 月
																<?php echo Arr::get($profile, "birthd", "");?> 日
												</td>
												<td class="txt"><?php echo Arr::get($profile, "sex", "");  ?> </td>
												<td class="txt">〒<?php echo Arr::get($profile, "post_no", "");?> <br />
																<?php echo Arr::get($profile, "pref", "");?> 
																<?php echo Arr::get($profile, "addr1", "");?> <br />
																<?php echo Arr::get($profile, "addr2", "");?> 
												</td>
												<td class="txt"><?php echo Arr::get($profile, "tel", "");?> </td>
