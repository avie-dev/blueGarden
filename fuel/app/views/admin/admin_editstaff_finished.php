					...
					<table width="100%">
						...
						<tr>
							<td colspan="2" style="font-size: 18px;"　>
								<strong>従業員情報編集　―完了―</strong><hr />
							</td>
							
						</tr>	
						
						<tr><td>従業員情報の編集が完了しました。</td></tr>
						
					</table> 
						
							<tr>	
								
								<form action="staffinfo" name="addnewmem_ok" method="post"　>
									<input name="submit" type="submit" value="従業員情報ページトップへ" >
