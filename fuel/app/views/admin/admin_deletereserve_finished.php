				...
				<div class="coldivider_center" style="margin-top:80px;">
					 <form id="quit" method="post" action="">
						...
						<table>
							...
							<tr>
								<td align="center">
									<form action="top" name="reservedelete_ok_pagetop" method="post">
										<input name="submit" type="submit" value="Myページトップへ" >
										
									</form>
								</td>
								<td align="center" >
							
									<form action="reserveinfo" name="reservedelete_ok_topictop" method="post"　>
										<input name="submit" type="submit" value="予約管理ページトップへ" >
