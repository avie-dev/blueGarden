	   	...
	   	<div id="bluegarden_content">
				...
				<div class="coldivider_center" style="margin-top:80px;">
					...
					<div class="box-type1 ns">
								<form action="editstaff_confirm" name="editstaff_confirm" method="post"　>	
									  ...
									  <table width="100%" border="0" class="type1">
										...
										<th width="150">スタッフ番号</th>
										  ...
										  <?php 
											...
											?>
										  <?php echo Form::input('staff_no',Input::post('staff_no',$row['staff_no']),array('size'=>'50','class' => 'textinput')) ?>
										...
										<th width="150">スタッフ名</th>
										  <td>
										  <?php echo Form::input('staff_name',Input::post('staff_name',$row['staff_name']),array('size'=>'50','class' => 'textinput')) ?>
										...
										$sex = Session::get('ssex');
											
											if(($sex==='女')||($sex==='1'))
											{
												echo Form::label('男性','gender_male');
												echo Form::radio('sex', '男', array( 'id'=>'form_gender_male'));
												echo Form::label('女性','gender_female');
												echo Form::radio('sex','女', array('checked'=>'checked','id'=>'form_gender_female'));
											}
											if(($sex==='男')||($sex==='2'))
											{
												echo Form::label('男性','gender_male');
												echo Form::radio('sex', '男', array( 'checked'=>'checked','id'=>'form_gender_male'));
												echo Form::label('女性','gender_female');
												echo Form::radio('sex','女', array('id'=>'form_gender_female'));
											}
											if($sex===null)
											{
												echo Form::label('男性','gender_male');
										...
										<tr>
											...
											<td>
												<?php echo Form::input('staff_intro',Input::post('staff_intro',$row['introduce']),array('size'=>'50','class' => 'textinput')) ?>
										...
										<tr>
											<th width="150">時給</th>
											<td>
												<?php echo Form::input('rate',Input::post('rate',$row['hour_rate']),array('size'=>'10','class' => 'textinput')) ?>
												円
											</td>
										</tr>						
										<tr>	
