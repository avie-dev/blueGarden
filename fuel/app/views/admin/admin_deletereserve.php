						...
						<table width="100%" style="border:none">
							<tr>
								<td colspan="2" style="font-size: 18px;"　>
									<strong>予約削除</strong><hr />
								</td>
							
							</tr>	
							<tr style="border:none">
								<td class="spacer" align="center" style="border:none" >  
										予約番号：
										<?php echo $resno ?>　	を予約を編集/削除しますか？
							...
							<tr>
								<td align="right">
										<form method="post" action="reserveedit">
										<?php echo Form::hidden('resno',Input::post('resno',$resno),array('type'=>'hidden','size'=>'20')); ?>
										<input type="submit" name="" value="編集">
										</form>	
										<form action="deletereserve_finished" id="reservedel_ok" name="reservedel_ok" method="post"　>
										<input name="submit" type="submit" value="削除する" ><br>									
