	    ...
	    <div class="box-type1 ns">
			  <table width="100%" border="0" class="type1">		  
			    ...
			    <tr>
			      ...
			      <td><br />
			        &nbsp;&nbsp;&nbsp;&nbsp
					<?php echo Form::input('cus_tel', Input::post('cus_tel'), array('size'=>'20','placeholder'=>'（例）0453678849', 'class' => 'textinput') ) ?><span class="attention" style="font-size:12px">&nbsp;&nbsp;半角数字のみ</span>
			    ...
			    <tr>
			      ...
			      <td><br />
			        &nbsp;&nbsp;&nbsp;&nbsp
					<?php echo Form::input('cus_zip', Input::post('cus_zip'), array('size'=>'20','placeholder'=>'（例）2330013', 'class' => 'textinput'),array('min_length' => '7')) ?><span class="attention" style="font-size:12px">&nbsp;&nbsp;半角数字のみ</span>
		          ...
		          <th><span class="attention">＊</span>パスワード</th>
					...
					<?php echo Form::input('loginpw', Input::post('loginpw'), array('type'=>'password','required' => 'required', 'class' => 'password')) ?>
		              <!--<input type="password" id="bt_form_loginpw" name="loginpw"  size="50" value="" style="ime-mode:disabled">
							-->
		              <span class="attention" style="font-size:12px"><br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;※半角英数字記号 4～20文字で入力してください</span>
		              <p class="attention"></p>&nbsp;&nbsp;&nbsp;
