        ...
        <div id="bluegarden_right">
        	...
        	<div class="right_col_section">
				...
				<table width="90%" style="margin-top:20px;margin-bottom:20px;">
					...
					<tr>
						<td class="ptablespacer" width="20%"><h3><p>メールアドレス</p></h3></td>
						<td class="ptablespacer"><h3><?php echo $email ?></h3>
						</td>
						
					</tr>
					<tr>
						<td class="ptablespacer"><h3><p>お名前</p></h3></td>
						<td class="ptablespacer"><h3><?php echo $name ?></h3>
						</td>
					</tr>
					<tr>
						<td class="ptablespacer"><h3><p>フリカナ</p></h3></td>
						<td class="ptablespacer"><h3><?php echo $kana ?></h3></td>
					</tr>
					<tr>
						<td class="ptablespacer" ><h3><p>電話番号</p></h3></td>
						<td class="ptablespacer" ><h3><?php echo $tel ?></h3></td>
					</tr>
					<tr>
						<td class="ptablespacer" ><h3><p>郵便番号</p></h3></td>
						<td class="ptablespacer" ><h3><?php echo $postno ?></h3></td>
					</tr>
					<tr>
						<td class="ptablespacer" ><h3><p>住所</p></h3></td>
						<td class="ptablespacer" ><h3><?php echo $pref ?><?php echo $addr1 ?><?php echo $addr2 ?></h3></td>
					</tr>
					<tr>
						<td class="ptablespacer" ><h3><p>性別</p></h3></td>
						<td class="ptablespacer" ><h3><?php echo $sex ?></h3></td>
					</tr>
					<tr>
						<td class="ptablespacer" ><h3><p>生年月日</p></h3></td>
						<td class="ptablespacer" ><h3><?php echo $birthy ?>年<?php echo $birthm ?>月<?php echo $birthd ?>日</h3></td>
					</tr>
					<tr>
