	    ...
	    <!-- left column -->
	   	<div id="bluegarden_content">
					...
					<p class="columntitle" style="text-align:center;">ログイン</p>
					 ...
					 <form id="form1" name="form1" method="post" action="login">
						<table width="100%" style="border:none" class="loginspacer">
							...
							<tr>
								<td style="border:none">パスワード </td><td style="border:none"><input style="width:150px" type="text" name="password" id="password" /></td>
							</tr>
							<tr>
			...
			<p>&nbsp;</p>
				...
				<table  width="100%"><tr class="columntitle_button"><td>ログアウト</td></tr></table>
			           <p>&nbsp;</p><center>
					   ログアウトしました。
			          </center><p>&nbsp;</p>
			  </div>
